...
function modify_category_labels() {
    ...
    if ( isset( $wp_taxonomies['category'] ) ) {
        $wp_taxonomies['category']->labels = (object) array(
            'name'                       => __( 'Asset Types', 'textdomain'  ),
            'singular_name'              => __( 'Asset Type', 'textdomain'  ),
            'search_items'               => __( 'Search Asset Types', 'textdomain'  ),
            'all_items'                  => __( 'All Asset Types', 'textdomain'  ),
            'parent_item'                => __( 'Parent Asset Type', 'textdomain'  ),
            'parent_item_colon'          => __( 'Parent Asset Type:', 'textdomain'  ),
            'edit_item'                  => __( 'Edit Asset Type', 'textdomain'  ),
            'update_item'                => __( 'Update Asset Type', 'textdomain'  ),
            'add_new_item'               => __( 'Add New Asset Type', 'textdomain'  ),
            'new_item_name'              => __( 'New Asset Type Name', 'textdomain'  ),
            'menu_name'                  => __( 'Asset Types', 'textdomain'  ),
            'view_item'                  => __( 'View Asset Type', 'textdomain'  ),
            'popular_items'              => __( 'Popular Asset Types', 'textdomain'  ),
            'separate_items_with_commas' => __( 'Separate asset types with commas', 'textdomain'  ),
            'add_or_remove_items'        => __( 'Add or remove asset types', 'textdomain'  ),
            'choose_from_most_used'      => __( 'Choose from the most used asset types', 'textdomain'  ),
            'not_found'                  => __( 'No asset types found', 'textdomain'  ),
            'no_terms'                   => __( 'No asset types', 'textdomain'  ),
            'items_list_navigation'      => __( 'Asset Types list navigation', 'textdomain'  ),
            'items_list'                 => __( 'Asset Types list', 'textdomain'  ),
            'most_used'                  => __( 'Most Used', 'textdomain'  ),
            'back_to_items'              => __( '← Back to Asset Types', 'textdomain'  ),
            'filter_by_item'             => __( 'Filter by Asset Type', 'textdomain'  ),
        );
    }
}
